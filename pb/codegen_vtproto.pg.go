...
func (this *Settings) EqualVT(that *Settings) bool {
	...
	for i := range this.Queries {
		if this.Queries[i] != that.Queries[i] {
			return false
		}
	}
	...
	for i := range this.Rename {
		if this.Rename[i] != that.Rename[i] {
			return false
		}
	}
	...
	for i := range this.Overrides {
		if !this.Overrides[i].EqualVT(that.Overrides[i]) {
			return false
		}
	}
	if !this.Go.EqualVT(that.Go) {
		return false
	}
...
func (this *GoCode) EqualVT(that *GoCode) bool {
	...
	if this.EmitInterface != that.EmitInterface {
		return false
	}
	...
	if this.EmitPreparedQueries != that.EmitPreparedQueries {
		return false
	}
	if this.EmitExactTableNames != that.EmitExactTableNames {
		return false
	}
	if this.EmitEmptySlices != that.EmitEmptySlices {
		return false
	}
	if this.EmitExportedQueries != that.EmitExportedQueries {
		return false
	}
	if this.EmitResultStructPointers != that.EmitResultStructPointers {
		return false
	}
	if this.EmitParamsStructPointers != that.EmitParamsStructPointers {
		return false
	}
	if this.EmitMethodsWithDbArgument != that.EmitMethodsWithDbArgument {
		return false
	}
	if this.JsonTagsCaseStyle != that.JsonTagsCaseStyle {
		return false
	}
	if this.Package != that.Package {
		return false
	...
	if this.SqlPackage != that.SqlPackage {
		return false
	}
	if this.OutputDbFileName != that.OutputDbFileName {
		return false
	}
	if this.OutputModelsFileName != that.OutputModelsFileName {
		return false
	}
	if this.OutputQuerierFileName != that.OutputQuerierFileName {
		return false
	}
	if this.OutputFilesSuffix != that.OutputFilesSuffix {
		return false
	}
	if this.EmitEnumValidMethod != that.EmitEnumValidMethod {
		return false
	}
	if this.EmitAllEnumValues != that.EmitAllEnumValues {
		return false
	}
	if len(this.InflectionExcludeTableNames) != len(that.InflectionExcludeTableNames) {
		return false
	}
	for i := range this.InflectionExcludeTableNames {
		if this.InflectionExcludeTableNames[i] != that.InflectionExcludeTableNames[i] {
			return false
		}
	}
...
func (this *Catalog) EqualVT(that *Catalog) bool {
	...
	for i := range this.Schemas {
		if !this.Schemas[i].EqualVT(that.Schemas[i]) {
			return false
		}
	}
	return string(this.unknownFields) == string(that.unknownFields)
...
func (this *Schema) EqualVT(that *Schema) bool {
	...
	for i := range this.Enums {
		if !this.Enums[i].EqualVT(that.Enums[i]) {
			return false
		}
	}
	...
	for i := range this.CompositeTypes {
		if !this.CompositeTypes[i].EqualVT(that.CompositeTypes[i]) {
			return false
		}
	}
	return string(this.unknownFields) == string(that.unknownFields)
...
func (this *Query) EqualVT(that *Query) bool {
	...
	for i := range this.Params {
		if !this.Params[i].EqualVT(that.Params[i]) {
			return false
		}
	}
	...
	for i := range this.Comments {
		if this.Comments[i] != that.Comments[i] {
			return false
		}
	}
	if this.Filename != that.Filename {
...
func (this *CodeGenRequest) EqualVT(that *CodeGenRequest) bool {
	...
	for i := range this.Queries {
		if !this.Queries[i].EqualVT(that.Queries[i]) {
			return false
		}
	}
...
func (m *JSONCode) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Indent) > 0 {
		i -= len(m.Indent)
		copy(dAtA[i:], m.Indent)
		i = encodeVarint(dAtA, i, uint64(len(m.Indent)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Out) > 0 {
...
func (m *Settings) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			...
			if err := m.Json.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 12:
...
func (m *GoCode) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 19:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EmitEnumValidMethod", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EmitEnumValidMethod = bool(v != 0)
		case 20:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EmitAllEnumValues", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 22:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EmitPointersForNullTypes", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *JSONCode) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: JSONCode: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: JSONCode: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Indent", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Indent = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
